...
export default function App(): JSX.Element {
   ...
   */
  function handleMetricChange(metricName: MetricName, newScore: MetricScore): void {
    // Update state
    setMetrics((prev) => ({
      ...prev,
      [metricName]: newScore,
  ...
  if (isViewingMode) {
    return (
      <ViewingMode metrics={metrics} profileName={sharedName} onCreateOwn={handleSwitchToEditor} />
    );
  }
    ...
    <div className="container">
      ...
      <main id="main-content">
          ...
          <>
            ...
            {sharedName && (
              <div className="shared-banner" role="status">
                <span>
                  📱 Viewing <strong>{sharedName.slice(0, 50).replace(/[<>]/g, '')}'s</strong>{' '}
                  settings
                </span>
                <button
            ...
            <div className="intro-section">
              ...
              <p className="intro-description">
                This tool helps you explore neurodiversity across six key dimensions: Focus, Social
                Interaction, Sensory Sensitivity, Motor Skills, Routine Preference, and Emotional
                Regulation. Adjust each metric from 0-5 to receive personalized, evidence-based
                support strategies tailored to your unique profile. Whether you're a parent,
                teacher, caregiver, or individual on your own journey, these insights can help
            ...
            <section id="metrics" aria-label="Neurodiversity Metrics">
              ...
              <div className="grid">
                {Object.keys(settingsData).map((metricName) => {
                  ...
                  const metricValues = (settingsData as Record<string, unknown[]>)[
                    metricName
                  ] as { score: number; description: string }[];
                  return (
                    <MetricSlider
                      key={metricName}
                      category={metricName}
        ...
        {currentView === 'share' && (
          <>
            {/* Back to Edit Button */}
            <button className="back-to-edit-btn" onClick={() => setCurrentView('edit')}>
            ...
            >
              ...
              <p className="section-description">
                Share your neurodiversity profile with teachers, therapists, family members, or
              ...
              <div className="share-card">
                ...
                <div className="share-content">
                  <p className="share-content__description">
                    Share your profile via link or QR code. Anyone with access can view your
                    settings.
                  </p>
                  ...
                  <div className="qr-code-container">
                    <QRCodeSVG
                      ...
                      fgColor="#1f2937"
                    />
                    {shareName && <p className="qr-name-label">{shareName}'s Spectrum Settings</p>}
                  </div>
                ...
                <p className="share-privacy-note">
                  🔒 The link contains only your metric scores{shareName ? ' and name' : ''}. No
                  personal data is stored on any server.
                </p>
              </div>
              ...
              <div className="secondary-options">
                ...
                <button onClick={handleDownloadCSV} className="secondary-options__link">
                  📥 Download CSV Report
                </button>
                <button
              ...
              {showPlaintext && (
                <div className="plaintext-section">
                  ...
                  <pre
                    className="plaintext"
                    aria-live="polite"
                    aria-label="Current metrics in plaintext"
                  >
                    {generatePlaintext(
                      metrics,
                      settingsData as Record<string, { score: number; description: string }[]>
            ...
            >
              <SupportStrategiesSection recommendations={recommendations} metrics={metrics} />
            </CollapsibleSection>
            ...
            >
              <div className="about-content">
                <div className="about-story">
                  ...
                  <p>
                    As a parent of a neurodivergent child, I found it challenging to communicate my
                    child's unique needs to teachers, therapists, and family members. This tool was
                    born from that experience – a simple way to visualise and share a neurodiversity
                    profile without lengthy explanations.
                  </p>
                  <p>
                    Full transparency: this project was largely "vibe coded" with AI assistance.
                    That said, I work in the software industry, so while the approach was
                    experimental, I've kept an eye on code quality and best practices along the way.
                  </p>
                  <p>
                    My Spectrum is <strong>completely free</strong>, <strong>open source</strong>,
                    and <strong>privacy-first</strong>. No accounts, no tracking, no data
                    collection. Your information never leaves your device.
                  </p>
                </div>
                ...
                <div className="about-support">
                  ...
                  <p>
                    If you find this tool helpful, consider supporting its development. Your
                    contribution helps keep it free and continuously improving.
                  </p>
                ...
                <div className="about-connect">
                  <h3>Get In Touch</h3>
                  <p>
                    Have feedback, suggestions, or just want to say hello? I'd love to hear from
                    you.
                  </p>
                  <form
                  ...
                  >
                    <input
                      type="hidden"
                      name="access_key"
                      value="06242b3b-30ed-4a0a-90dc-88e138e594b4"
                    />
      ...
      <footer className="app-footer">
        <p>
          <strong>💚 Your privacy matters:</strong> All data stays on your device. Nothing is sent
          to any server.
        </p>
        ...
        <div className="footer-legal">
          <button className="footer-legal-link" onClick={() => setLegalPage('privacy')}>
            Privacy Policy
          </button>
          <span className="footer-divider">•</span>
          <button className="footer-legal-link" onClick={() => setLegalPage('terms')}>
            Terms of Service
          </button>
        </div>
      </footer>

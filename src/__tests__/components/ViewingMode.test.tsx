...
describe('ViewingMode', () => {
  ...
  describe('Header rendering', () => {
    it('should display "Shared Neurodiversity Profile" when no name is provided', () => {
      render(
        <ViewingMode metrics={defaultMetrics} profileName={null} onCreateOwn={mockOnCreateOwn} />
      );
    ...
    it('should display personalized header when name is provided', () => {
      render(
        <ViewingMode metrics={defaultMetrics} profileName="Alex" onCreateOwn={mockOnCreateOwn} />
      );
  ...
  describe('Profile summary', () => {
    ...
    it('should identify high support areas when scores are low', () => {
      ...
      render(<ViewingMode metrics={lowMetrics} profileName={null} onCreateOwn={mockOnCreateOwn} />);
    ...
    it('should identify strength areas when scores are high', () => {
      ...
      render(
        <ViewingMode metrics={highMetrics} profileName={null} onCreateOwn={mockOnCreateOwn} />
      );

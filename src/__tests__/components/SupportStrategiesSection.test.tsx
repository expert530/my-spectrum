...
describe('SupportStrategiesSection', () => {
  ...
  it('should render the section heading', () => {
    render(
      <SupportStrategiesSection recommendations={defaultRecommendations} metrics={defaultMetrics} />
    );
  ...
  it('should return null when recommendations is null', () => {
    const { container } = render(
      <SupportStrategiesSection recommendations={null} metrics={defaultMetrics} />
    );
  ...
  it('should return null when recommendations are empty', () => {
    ...
    const { container } = render(
      <SupportStrategiesSection recommendations={emptyRecommendations} metrics={defaultMetrics} />
    );
  ...
  it('should display correct support level for low scores', () => {
    ...
    render(
      <SupportStrategiesSection recommendations={defaultRecommendations} metrics={lowMetrics} />
    );
  ...
  it('should display correct support level for high scores', () => {
    ...
    render(
      <SupportStrategiesSection recommendations={defaultRecommendations} metrics={highMetrics} />
    );

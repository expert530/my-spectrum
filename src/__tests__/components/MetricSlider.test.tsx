...
describe('MetricSlider', () => {
  ...
  it('should render with the provided category', () => {
    render(
      <MetricSlider category="Focus" values={sampleValues} value={3} onChange={mockOnChange} />
    );
  ...
  it('should display the current value', () => {
    render(
      <MetricSlider category="Focus" values={sampleValues} value={4} onChange={mockOnChange} />
    );
  ...
  it('should display intensity label based on value', () => {
    render(
      <MetricSlider category="Focus" values={sampleValues} value={1} onChange={mockOnChange} />
    );

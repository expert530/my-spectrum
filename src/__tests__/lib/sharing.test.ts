...
const mockSettingsData: Record<string, { score: number; description: string }[]> = {
  Focus: Array.from({ length: 6 }, (_, i) => ({
    score: i,
    description: `Focus level ${i} description`,
  })),
  'Social Interaction': Array.from({ length: 6 }, (_, i) => ({
    score: i,
    description: `Social level ${i} description`,
  })),
  'Sensory Sensitivity': Array.from({ length: 6 }, (_, i) => ({
    score: i,
    description: `Sensory level ${i} description`,
  })),
  'Motor Skills': Array.from({ length: 6 }, (_, i) => ({
    score: i,
    description: `Motor level ${i} description`,
  })),
  'Routine Preference': Array.from({ length: 6 }, (_, i) => ({
    score: i,
    description: `Routine level ${i} description`,
  })),
  'Emotional Regulation': Array.from({ length: 6 }, (_, i) => ({
    score: i,
    description: `Emotional level ${i} description`,
  })),
};
...
const mockTeacherResources = [
  {
    title: 'Teacher Resource 1',
    url: 'https://example.com/teacher1',
    description: 'Description 1',
  },
  {
    title: 'Teacher Resource 2',
    url: 'https://example.com/teacher2',

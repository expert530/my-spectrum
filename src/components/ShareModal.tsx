    ...
    <>
      ...
      <div className="modal share-modal" role="dialog" aria-labelledby="share-modal-title">
        <div className="modal-content">
          <button onClick={onClose} className="modal-close" aria-label="Close share modal">
            ✕
          </button>
          ...
          <p className="share-description">
            Generate a QR code to share your spectrum settings. Others can scan it to instantly load
            your profile.
          </p>
          ...
          <div className="qr-code-container">
            <QRCodeSVG
              ...
              fgColor="#1f2937"
            />
            {name && <p className="qr-name-label">{name}'s Spectrum Settings</p>}
          </div>
          ...
          <p className="share-privacy-note">
            🔒 The QR code contains only your metric scores{name ? ' and name' : ''}. No personal
            data is stored on any server.
          </p>
        </div>
      </div>
    </>

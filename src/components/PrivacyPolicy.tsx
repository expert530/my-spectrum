  ...
  return (
    <div className="legal-page">
      ...
      <section className="legal-section">
        ...
        <p>
          <strong>
            My Spectrum does not collect, store, or transmit any of your personal data.
          </strong>
      ...
      <section className="legal-section">
        ...
        <p>Any data you create is stored in your browser's local storage. This data:</p>
        <ul>
      ...
      <section className="legal-section">
        ...
        <p>
          <strong>Important:</strong> Anyone you share this URL with will be able to see the profile
          settings contained in it. Only share with people you trust.
        </p>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>
          We do not use cookies for tracking purposes. We do not use any analytics services. We do
          not track your usage of this application in any way.
        </p>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>
          The contact form uses Web3Forms to deliver messages. If you choose to use the contact
          form, your message and any information you provide will be processed by Web3Forms
          according to their privacy policy. This is entirely optional.
        </p>
      </section>
      ...
      <section className="legal-section">
        ...
        <ul>
          <li>
            <strong>Access:</strong> Your data is in your browser's local storage
          </li>
          <li>
            <strong>Deletion:</strong> Clear your browser data to remove all stored information
          </li>
          <li>
            <strong>Portability:</strong> Use the CSV export feature to download your profile
          </li>
        </ul>
      </section>
      ...
      <section className="legal-section">
        ...
        <p>
          ...
          top of this page. Since this is an open-source project, all changes are visible in our
          version history.
        </p>
      </section>
      ...
      <section className="legal-section">
        <h2>Contact</h2>
        <p>
          If you have questions about this privacy policy, please use the contact form in the "About
          This Tool" section of the main application.
        </p>
      </section>
    </div>
  );

  ...
  return (
    <section id="strategies" className="strategies-section" aria-label="What Helps">
      ...
      <p className="strategies-intro">
        Based on your profile, here are evidence-based strategies to provide better support. These
        update automatically as you adjust your settings.
      </p>
      <button
          ...
          {Object.entries(metrics).map(([name, score]) => (
            <div key={name} className="profile-metric-item">
              <div className="profile-metric-header">
                ...
                <span className="profile-metric-level" style={{ color: getScoreColor(score) }}>
        ...
        {parentStrategies.length > 0 && (
          <div className="strategies-subsection">
            ...
            >
              ...
              <span
                className={`strategies-subsection__chevron ${parentStrategiesExpanded ? 'strategies-subsection__chevron--expanded' : ''}`}
              >
                ▼
              </span>
            </button>
        ...
        {teacherStrategies.length > 0 && (
          <div className="strategies-subsection">
            ...
            >
              ...
              <span
                className={`strategies-subsection__chevron ${teacherStrategiesExpanded ? 'strategies-subsection__chevron--expanded' : ''}`}
              >
                ▼
              </span>
            </button>
